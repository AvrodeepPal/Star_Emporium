...
public class AdminRegister extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel10.setBorder(javax.swing.BorderFactory.createCompoundBorder(new javax.swing.border.LineBorder(new java.awt.Color(255, 255, 255), 1, true), new javax.swing.border.LineBorder(new java.awt.Color(255, 0, 255), 2, true)));
    ...
    private void jLabel10MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel10MouseClicked
        ...
        try {
            ...
            ps = con.prepareStatement("SELECT * FROM AdminProfile WHERE email=?");
            ...
            if (rs.next()) {
                ...
                do {
                    admid = generateAdmid();
                    ps = con.prepareStatement("SELECT * FROM AdminProfile WHERE adm_id=?");
                    ps.setString(1, admid);
                    rs = ps.executeQuery();
                } while (rs.next());
                ps = con.prepareStatement("INSERT INTO AdminProfile(adm_id,fname,lname,email) VALUES(?,?,?,?)");
                ps.setString(1, admid);
                ...
                ps.executeUpdate();
                ps = con.prepareStatement("INSERT INTO AdmLgn(adm_id,pswrd,fpques,fpans) VALUES(?,?,?,?)");
                ps.setString(1, admid);
                ...
                ps.executeUpdate();
                String sf = "Admin Registration Successful!\nAdmin ID : " + admid + "\nPassword : " + jPasswordField1.getText().trim();
    ...
    private void jLabel10MouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel10MouseEntered
        ...
        jLabel10.setBackground(Color.decode("#ff00ff"));
    }//GEN-LAST:event_jLabel10MouseEntered

    private void jLabel10MouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel10MouseExited
        jLabel10.setForeground(Color.decode("#ff00ff"));
